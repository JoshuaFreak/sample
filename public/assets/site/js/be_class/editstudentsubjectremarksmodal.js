$(document).ready(function(){
    $('#editstudentsubjectremarksmodal').on('show.bs.modal', function(e) {   
    ...
    $(".EditStudentSubjectRemarks").click(function () {
        $.ajax({
            url:"../../teachers_portal/student_subject_remarks/postEdit",
            type:'post',
            data:{ 
        ...
        $("#editstudentsubjectremarksmodal").modal('hide');
