$(document).ready(function(){
    $('#newstudentsubjectremarksmodal').on('show.bs.modal', function(e) {   
        ...
        $('#student_subject_id').val(SubjectId)
    ...
    $(".SaveStudentRemarks").click(function () {
        $.ajax({
            url:"../../teachers_portal/student_subject_remarks/postCreate",
            type:'post',
            data:{ 
                    'remarks': $("#remarks").val(),
                    ...
                    'subject_id': $("#student_subject_id").val(),
                    '_token': $('input[name=_token]').val(),
                },
            async:false
        });
        $("#newstudentsubjectremarksmodal").modal('hide');
