$(document).ready(function(){
         $('#studentsubjectremarksmodal').on('show.bs.modal', function(e) {   
            ...
            studentsubjectremarkstable.fnDraw();
        });

        studentsubjectremarkstable = $('#studentsubjectremarkstable').dataTable( {
            "sDom": "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-6'i><'col-md-6'p>>",
            "sPaginationType": "bootstrap",
            "bProcessing": true,
            "bServerSide": true,
            "bStateSave": true,
            "sAjaxSource": "../../teachers_portal/student_subject_remarks/conduct_student_remarks_data",
