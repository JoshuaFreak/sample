    ...
    $('#academicprojectionmodal').on('shown.bs.modal', function (e) {
        ...
        hot = new Handsontable(container, {
            ...
            cells : function(row, col, prop, td) {
                ...
                }else if (data[row][0] == "Social Studies" || data[row][0] == "Phil. History & Geography" ||  data[row][0] == "Asian History" ||  data[row][0] == "Philippine Economics" ||  data[row][0] == "World History" ||  data[row][0] == "Basic History of Civilization" ||  data[row][0] == "Elective: Rizal") {
