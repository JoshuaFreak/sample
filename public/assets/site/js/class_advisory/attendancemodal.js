...
function modifyAttendance() {
    $("#edit_delete").click(function(){
        ...
        $("#load_attendance").click(function(){
            $.ajax({
                url:"../../teachers_portal/class_advisory/modifyDataJsonStudentAttendance",
                type:'get',
                data:{  
                        'term_id' : term_id,
                        ...
                        $("[data-toggle=confirmation]").confirmation({container:"body",btnOkClass:"btn btn-sm btn-success",btnCancelClass:"btn btn-sm btn-danger",
                                onConfirm:function(event, element) {
                                 var id = $(this).data('id');
                                    ...
                                    $.ajax({
                                        url:"../../teachers_portal/class_advisory/removeStudentAttendance",
                                        type:'post',
                                        data:{  
                                                'id' : id,
        ...
        $("#save_changes").click(function(){
            ...
            $("input[name='date_data']").each(function(){
                ...
                var id = $(this).data('id')
                        $.ajax({
                            url:"../../teachers_portal/class_advisory/updateStudentAttendanceDate",
                            type:'post',
                            data:{  
                                    'id' : id,
                                    'value' : value,
...
function AttendanceHandsonTable() {
    ...
    $('#attendancemodal').on('shown.bs.modal', function (e) {
        ...
        $.ajax({
            url:"../../teachers_portal/class_advisory/dataJsonStudentAttendance",
            type:'get',
            data:{  
                    'term_id' : TermId,
        ...
        hot = new Handsontable(container, {
            ...
            afterChange: function (changes, source) {
                ...
                if(changes != null){
                    ...
                    $.ajax({
                        url: "../../teachers_portal/class_advisory/postStudentAttendance",
                        data: {
                            'id': student_id,
                            'rating': rating,
                            '_token': $('input[name=_token]').val(),
...
$(".btnSave").click(function () {
    ...
    {
        $.ajax({
            url:"../../teachers_portal/class_advisory/postAttendance",
            type:'post',
            data:{ 
                    'date': $("#date").val(),
