$(document).ready(function(){
    $('#deletestudentremarksmodal').on('show.bs.modal', function(e) {   
    ...
    $(".deleteStudentRemarks").click(function () {
        $.ajax({
            url:"../../teachers_portal/student_remarks/postdelete",
            type:'post',
            data:{ 
        ...
        $("#deletestudentremarksmodal").modal('hide');
