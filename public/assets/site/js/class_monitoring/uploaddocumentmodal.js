  $(document).ready(function(){
     ...
     $('#uploadDocumentModal').on('show.bs.modal', function(e) { 
            ...
            if(folder_id != "")
            {
                ...
                $.ajax({
                url:"../../teachers_portal/class_monitoring/studentFolderDataJson",
                type:'get',
                data:{ 
                    'folder_id' : folder_id,
                    },
            ...
            $(".upload").click(function(){
                ...
                $.ajax({
                    url:"../../teachers_portal/class_monitoring/upload_file",
                    type:'post',
                    datatype:'script',
                    contentType:false,
                    processData:false,
        ...
        $(".btnSaveFolder").click(function () {
            $.ajax({
                url:"../../teachers_portal/class_monitoring/postUpdateFolder",
                type:'post',
                data:{ 
    ...
    $("#save_student_document").click(function(){    
        ...
        for(var i=1; i<= $("#student_document_count").val(); i++)
        {
            ...
            {
                $.ajax({
                        url:"../../teachers_portal/class_monitoring/studentDocumentpostUpdate",
                        type:'post',
                        data: 
                            { 
