...
<div id="page-wrapper">
  <div class="row">
		<div class="page-header"><br>
		  <h2>Student Population By Gender Report</h2>
		</div>
    ...
    <form>
      <div class="form-horizontal">
          <div class="col-md-12">
              ...
              <div class="col-md-3">
                  <select class="form-control" name="classificat ion_level_id" id="classification_level_id">
    ...
    <div class="col-md-12">
      <div class="col-md-6" style="display:none;" id="population">
        <div class="col-md-12">
          <h3>No. of Males and Females of Students</h3>
        </div>
...
<script>
    ...
    $('form').submit(function(e){
      ...
      $.ajax({
        url: '{{URL::to("admin/reports/student_population_gender/data")}}',
        type: 'GET',
        data: {
