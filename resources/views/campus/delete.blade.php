...
{{-- Web site Title --}}
@section('title')
{{{ Lang::get("campus.delete_campus") }}} :: @parent
@stop
...
<div id="page-wrapper">
    <div class="row">
        <div class="page-header"><br>
            <h3> {{{ Lang::get("campus.delete_campus") }}}  
        ...
        <div>
            {{ Lang::get("campus.delete_message") }}
        </div>
        <form class="form-horizontal" method="post" action="{{ URL::to('campus/' . $campus->id . '/delete') }}" autocomplete="off">
