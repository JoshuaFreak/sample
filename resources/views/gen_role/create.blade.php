...
{{-- Web site Title --}}
@section('title')
{{{ Lang::get("gen_role.create_role") }}} :: @parent
@stop
...
<div id="page-wrapper">
    <div class="row">
		<div class="page-header"><br>
			<h3> {{{ Lang::get("gen_role.create_role") }}}
		...
		<form class="form-horizontal" method="post" action="{{ URL::to('gen_role/create') }}" autocomplete="off">
