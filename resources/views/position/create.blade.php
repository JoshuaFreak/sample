...
{{-- Web site Title --}}
@section('title')
{{{ Lang::get("position.create_new_position") }}} :: @parent
@stop
...
<div id="page-wrapper">
    <div class="row">
		...
		<div class="page-header"><br>
			<h3 style="margin-top: -12px !important;margin-left: 20px !important;" align="left"> {{{ Lang::get("position.create_new_position") }}}
		...
		<form class="form-horizontal" method="post" action="{{ URL::to('position/create') }}" autocomplete="off">
