...
<div id="page-wrapper">
    <div class="row">
		<div class="page-header"><br>
			<h3 style="margin-top: -12px !important;margin-left: 20px !important;"> {{{ Lang::get("position.edit_position") }}}
		...
		<form class="form-horizontal" method="post" action="{{ URL::to('position/' . $position->id . '/edit') }}" autocomplete="off">
