...
{{-- Web site Title --}}
@section('title')
{{{ Lang::get("room.edit_room") }}} :: @parent
@stop
...
<div id="page-wrapper">
    <div class="row">
		<div class="page-header"><br>
			<h3 style="margin-top: -12px !important;margin-left: 20px !important;"> {{{ Lang::get("room.edit_room") }}}
		...
		<form class="form-horizontal" method="post" action="{{ URL::to('room/' . $room->id . '/edit') }}" autocomplete="off">
