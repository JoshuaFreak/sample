...
<html lang="en">
    ...
    <head id="Starter-Site">
        ...
        <link href="{{asset('assets/site/bootstrap-toggle/css/bootstrap-toggle.min.css')}}" rel="stylesheet">
...
<body>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;">
        	<div class="container">
	            <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{!!URL::to('view_module')!!}" style="color:#FFFFFF"><img src="{{{ asset('assets/site/images/cia_logo.png') }}}" class="logo"></a>
	            </div>
    ...
    <footer style="margin-top: 50px;" id="default_footer">
        <div class="container">
    ...
    <script src="{{asset('assets/site/bootstrap-toggle/js/bootstrap-toggle.min.js')}}"></script> 
