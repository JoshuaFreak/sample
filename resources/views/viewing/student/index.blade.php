    ...
    <div class="row" style="padding:0px;margin: 0px;">
        ...
        <div class="page-header" style="margin-left: 3%;margin-right: 3%;"><br>
            <h3 style="margin-top: -12px !important;margin-left: 20px !important;" align="left">
                {{{ Lang::get("scheduler_view.student_schedule") }}}
            </h3>
        </div>
        </center>
...
$("#modalEditDelete").click(function(){
    var schedule_id = $(this).data('schedule_id');
        ...
        function(){
            $.ajax({
                url:'{{{ URL::to("scheduler_view/deleteClass") }}}',
                type:'POST',
                data: {
...
function deleteClassSchedule()
{
    $("#modalEditDeleteAll").click(function(){
        ...
        // $("#schedule_id_delete").val(schedule_id);
            ...
            function(){
                $.ajax({
                    url:'{{{ URL::to("scheduler_view/deleteClassAll") }}}',
                    type:'POST',
                    data: {
...
function call_sched(program_id,date,date_end,course_counter)
{
    ...
    $.ajax({
          url:'{{{ URL::to("scheduler_view/getStudentScheduleByCourse") }}}',
          type:'GET',
          dataType: "json",
          async:false,
          data:
          ...
          { 
                ...
                $.map(data_sched['data'],function(item){
                    ...
                    if(modal_count_loop == 1)
                    {
                        ...
                        selectListChange('modal_course_id','{{{URL::to("scheduler_view/programCourseDataJson")}}}',  { 'program_id': item.program_id },'modal_course_capacity_id' ,'Please select a Program');
                    ...
                    // selectListRoomSpaceChange('modal_room_id_'+item.class_id,'{{{URL::to("scheduler_view/courseCapacityRoomDataJson")}}}',  { 'course_capacity_id': data } ,'Please select a Class Capacity');
    ...
    $.ajax({
        ...
        {                  
            ...
            $.ajax({
                ...
                url:'{{ URL::to("scheduler_view/studentListLocal") }}',
                type:'GET',
                data: {
                    "_token": $("input[name=_token]").val(),
                    // "_token": "L3tM3P@55!",
            ...
            // {
                ...
                $("#modalEditDeleteDates").click(function(){
                    ...
                    if(counter_dates > 0)
                    {
                            ...
                            function(){
                                $.ajax({
                                    url:'{{{ URL::to("scheduler_view/deleteClassDates") }}}',
                                    type:'POST',
                                    data: {
                                        'date' : dates,
    ...
    if(modal_counter == 0)
    {
        ...
        $('#timeModal').on('shown.bs.modal', function(e) {
            ...
            if(modal_count_loop == 0)
            {
                ...
                $("#modal_program_id").change(function(){
                    ...
                    if(is_edit == 0)
                    {
                        ...
                        selectListChangeClass('modal_course_id','{{{URL::to("scheduler_view/programCourseDataJson")}}}',  { 'program_id': $("#modal_program_id").val() },'modal_course_capacity_id' ,'Please select a Program',date,date_end,1);
                        ...
                        // $.ajax({
                        //     url:'{{{ URL::to("scheduler_view/checkVacantSchedule") }}}',
                        //     type:'GET',
                        //     data: {
                        //         'program_id' : $(this).val(),
                        //     },
                ...
                $(".modal_course_capacity_id").change(function(){
                    ...
                    selectListRoomSpaceChange('modal_room_id_'+counter,'{{{URL::to("scheduler_view/courseCapacityRoomTeacherDataJson")}}}',  { 'course_capacity_id': data, 'class_id': counter, 'date': date,'date_end': date_end } ,'Please select a Class Capacity',counter);
                });
                $("#add_schedule_tab").click(function(){
                    ...
                    $("#course"+course_counter+" > form").each(function(){
                            ...
                            $(this).find(".db_id").each(function(){
                                ...
                                $(this).find("#modal_program_id").change(function(){
                                    ...
                                    // var date = $("#abrod_start").text();
                                    // date = date.replace("Departure Date: ", "");
                                    selectListChangeClass('modal_course_id','{{{URL::to("scheduler_view/programCourseDataJson")}}}',  { 'program_id': $(this).val() },'modal_course_capacity_id' ,'Please select a Program',date,date_end,course_counter);
                    ...
                    $(".modalCreate").click(function(){
                        ...
                        $(".tab-pane").each(function(){
                            ...
                            $.ajax({
                                url:'{{{ URL::to("scheduler_view/createStudent")}}}',
                                type:'post',
                                data:{ 
                                    '_token': $("input[name=_token]").val(),    
                                    // 'time_id':time_in_id, 
            ...
            //         {   
                        ...
                        modal_count++;
                        $.ajax({
                              url:'{{{ URL::to("scheduler_view/getStudentScheduleToday") }}}',
                              type:'GET',
                              dataType: "json",
                              async:false,
                              data:
                        ...
                        // });
                            ...
                            if(modal_counter == 0)
                            {
                                ...
                                $("#course"+course_counter).find(".modal_room_id").change(function(){
                                    ...
                                    $.ajax({
                                        url: "../scheduler_view/getRoomTeacher",
                                        data: 
                                        {
                                            'room_id' : $(this).val(), 
                                            'class_id' : counter, 
            ...
            // }
                ...
                $("#course"+course_counter).find(".modal_room_id").change(function(){
                    ...
                    counter = $(this).data('counter');
                    data = $("#course"+course_counter).find("#modal_course_capacity_id_"+counter).val();
                    // selectListRoomSpaceChange('modal_room_id_'+counter,'../scheduler_view/courseCapacityRoomTeacherDataJson',  { 'course_capacity_id': data, 'class_id': counter } ,'Please select a Class Capacity',counter);
                    // $.ajax({
                    //     url: "../scheduler_view/getRoomTeacher",
                    //     data: 
                    //     {
                ...
                $("#modal_delete_date").click(function(){
                    ...
                    function(){
                        $.ajax({
                            url:'{{{ URL::to("scheduler_view/deleteStudentClassSchedule") }}}',
                            type:'POST',
                            data: {
                                'student_id' : student_id,
                                'program_id' : program_id,
...
function getScheduleJson(date){
    ...
    $.ajax({
              url:'{{{ URL::to("scheduler_view/getScheduleDataJsonStudent") }}}',
              type:'GET',
              dataType: "json",
              async:false,
              data:
