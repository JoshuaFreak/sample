        ...
        <center>
            <div class="page-header" style="margin-left: 3%;margin-right: 3%;"><br>
                <h3 style="margin-top: -12px !important;margin-left: 20px !important;" align="left">
                    {{{ Lang::get("scheduler_view.teacher_schedule") }}}
...
$(function(){
    ...
    $("#modalSaveChanges").click(function(){
        ...
        $.ajax({
            url:'{{{ URL::to("scheduler_view/update_teacher_class") }}}',
            type:'POST',
            data: {
    ...
    $('#timeEditModal').on('show.bs.modal', function(e) {
        ...
        selectListChange('edit_modal_course_id','{{{URL::to("scheduler_view/programCourseDataJson")}}}',  { 'program_id': $("#edit_modal_program_id").val() } ,'Please select a Program');
        ...
        selectListChange('edit_modal_room_id','{{{URL::to("scheduler_view/courseCapacityRoomDataJson")}}}',  { 'course_capacity_id': data } ,'Please select a Program');
        ...
        $.ajax({
              url:'{{{ URL::to("scheduler_view/getBatchStudentDataJson") }}}',
              type:'GET',
              dataType: "json",
              async:false,
              data:
        ...
        $("#modalEdit").click(function(){
                    ...
                    $.ajax({
                        url:'{{{ URL::to("scheduler_view/edit")}}}',
                        type:'post',
                        data:{ 
                            '_token': $("input[name=_token]").val(),    
                            'date':$("#date").val(),
...
function getScheduleJson(date){
    ...
    $.ajax({
              url:'{{{ URL::to("scheduler_view/getScheduleByGroupDataJson") }}}',
              type:'GET',
              dataType: "json",
              async:false,
              data:
...
function loadSched(date){
    ...
    $.ajax({
        ...
        {                  
            ...
            $.ajax({
                url:'{{{ URL::to("scheduler_view/get_teacher_class") }}}',
                type:'GET',
                data: {
                    'date' : $("#date").val(),
                },
    ...
    $('#timeModal').on('show.bs.modal', function(e) {
        ...
        if(count == 0)
        {
            ...
            $("#modal_course_capacity_id").change(function(){
                ...
                selectListChange('modal_room_id','{{{URL::to("scheduler_view/courseCapacityRoomDataJson")}}}',  { 'course_capacity_id': $("#modal_course_capacity_id").val() } ,'Please select a Class Capacity');
            });
            count++;  
